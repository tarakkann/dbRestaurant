...
//    }
//
//    public static ObservableList<Ingredients> getIngridient() throws SQLException, ClassNotFoundException {
//        Connection connection1 = getDBConnection();
//        ObservableList<Ingredients> list = FXCollections.observableArrayList();
//        PreparedStatement ps = connection1.prepareStatement("SELECT * FROM ingridients");
//        ResultSet rs = ps.executeQuery();
//        while (rs.next()) {
//            list.add(new Ingredients(Integer.parseInt(rs.getString("id")),
//                    rs.getString("name"),
...
//    }
//
//    public static ObservableList<Client> getClient() throws SQLException, ClassNotFoundException {
//        Connection connection1 = getDBConnection();
//        ObservableList<Client> list = FXCollections.observableArrayList();
//        PreparedStatement ps = connection1.prepareStatement("SELECT * FROM clients");
//        ResultSet rs = ps.executeQuery();
//        while (rs.next()) {
//            list.add(new Client(Integer.parseInt(rs.getString("id")), rs.getString("tax_id"),
